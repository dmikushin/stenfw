 ...
 * 
 * This code was generated by Patus on 2012/04/07 16:33:12
 */
...
static void kernel(float *  *  u_0_1_out, float *  u_0_m1, float *  u_0_0, float *  u_0_1, float dt_dx_sq, int x_max, int y_max, int z_max, int cb_x, int cb_y, int cb_z, int chunk)
{
	...
	__m256 constarr0[] =  { const0, const0, const0, const0, const0, const0, const0, const0, const1, const1, const1, const1, const1, const1, const1, const1, const2, const2, const2, const2, const2, const2, const2, const2 } ;
	int64_t dummy39;
	int64_t dummy40;
	int64_t dummy41;
	int64_t dummy42;
			...
			*/
			{
				...
				for (p3_idx_z=v2_idx_z; p3_idx_z<v2_idx_z_max; p3_idx_z+=1)
				{
					for (p3_idx_y=v2_idx_y; p3_idx_y<(v2_idx_y_max-1); p3_idx_y+=2)
					{
						...
						"vmovups (%10), %%ymm0\n\t"
						"vmovups (%1), %%ymm1\n\t"
						"vfmsubps (%0), %%ymm0, %%ymm1, %%ymm0\n\t"
						"vmovups 64(%10), %%ymm1\n\t"
						"vmovups 8(%1), %%ymm3\n\t"
						"vaddps -8(%1), %%ymm3, %%ymm2\n\t"
						"vaddps (%1,%7,2), %%ymm2, %%ymm2\n\t"
						"vaddps (%1,%9,2), %%ymm2, %%ymm2\n\t"
						"vaddps (%1,%8,2), %%ymm2, %%ymm2\n\t"
						"vaddps (%1,%6,2), %%ymm2, %%ymm2\n\t"
						"vmulps %%ymm1, %%ymm2, %%ymm1\n\t"
						"vmovups 32(%10), %%ymm4\n\t"
						"vmovups 4(%1), %%ymm2\n\t"
						"vaddps -4(%1), %%ymm2, %%ymm3\n\t"
						"vaddps (%1,%7), %%ymm3, %%ymm3\n\t"
						"vaddps (%1,%9), %%ymm3, %%ymm3\n\t"
						"vaddps (%1,%8), %%ymm3, %%ymm3\n\t"
						"vaddps (%1,%6), %%ymm3, %%ymm3\n\t"
						"vfmaddps %%ymm1, %%ymm4, %%ymm3, %%ymm1\n\t"
						...
						"vmovaps (%10), %%ymm0\n\t"
						"vmovaps (%1), %%ymm2\n\t"
						"vfmsubps (%0), %%ymm0, %%ymm2, %%ymm1\n\t"
						"vmovaps 32(%1), %%ymm2\n\t"
						"vfmsubps 32(%0), %%ymm0, %%ymm2, %%ymm0\n\t"
						"vmovaps 64(%10), %%ymm2\n\t"
						"vmovups 8(%1), %%ymm4\n\t"
						"vaddps -8(%1), %%ymm4, %%ymm3\n\t"
						"vmovups 40(%1), %%ymm5\n\t"
						"vaddps 24(%1), %%ymm5, %%ymm4\n\t"
						"vaddps (%1,%7,2), %%ymm3, %%ymm3\n\t"
						"vaddps 32(%1,%7,2), %%ymm4, %%ymm4\n\t"
						"vaddps (%1,%9,2), %%ymm3, %%ymm3\n\t"
						"vaddps 32(%1,%9,2), %%ymm4, %%ymm4\n\t"
						"vaddps (%1,%8,2), %%ymm3, %%ymm3\n\t"
						"vaddps 32(%1,%8,2), %%ymm4, %%ymm4\n\t"
						"vaddps (%1,%6,2), %%ymm3, %%ymm3\n\t"
						"vaddps 32(%1,%6,2), %%ymm4, %%ymm4\n\t"
						"vmulps %%ymm2, %%ymm3, %%ymm3\n\t"
						"vmulps %%ymm2, %%ymm4, %%ymm2\n\t"
						"vmovaps 32(%10), %%ymm4\n\t"
						"vmovups 4(%1), %%ymm6\n\t"
						"vaddps -4(%1), %%ymm6, %%ymm5\n\t"
						"vmovups 36(%1), %%ymm7\n\t"
						"vaddps 28(%1), %%ymm7, %%ymm6\n\t"
						"vaddps (%1,%7), %%ymm5, %%ymm5\n\t"
						"vaddps 32(%1,%7), %%ymm6, %%ymm6\n\t"
						"vaddps (%1,%9), %%ymm5, %%ymm5\n\t"
						"vaddps 32(%1,%9), %%ymm6, %%ymm6\n\t"
						"vaddps (%1,%8), %%ymm5, %%ymm5\n\t"
						"vaddps 32(%1,%8), %%ymm6, %%ymm6\n\t"
						"vaddps (%1,%6), %%ymm5, %%ymm5\n\t"
						"vaddps 32(%1,%6), %%ymm6, %%ymm6\n\t"
						"vfmaddps %%ymm3, %%ymm4, %%ymm5, %%ymm3\n\t"
						"vfmaddps %%ymm2, %%ymm4, %%ymm6, %%ymm2\n\t"
						...
						: "rax", "rbx", "rcx", "xmm0", "xmm1", "xmm2", "xmm3", "xmm4", "xmm5", "xmm6", "xmm7", "memory", "cc"
						);
			...
			*/
			{
				...
				for (p3_idx_z=v2_idx_z; p3_idx_z<v2_idx_z_max; p3_idx_z+=1)
				{
					for (p3_idx_y=v2_idx_y; p3_idx_y<v2_idx_y_max; p3_idx_y+=1)
					{
						...
						"vmovaps (%10), %%ymm1\n\t"
						"vmovaps (%1), %%ymm2\n\t"
						"vfmsubps (%0), %%ymm1, %%ymm2, %%ymm0\n\t"
						"vmovaps 32(%1), %%ymm3\n\t"
						"vfmsubps 32(%0), %%ymm1, %%ymm3, %%ymm2\n\t"
						"vmovaps 64(%1), %%ymm4\n\t"
						"vfmsubps 64(%0), %%ymm1, %%ymm4, %%ymm3\n\t"
						"vmovaps 96(%1), %%ymm4\n\t"
						"vfmsubps 96(%0), %%ymm1, %%ymm4, %%ymm1\n\t"
						"vmovaps 64(%10), %%ymm4\n\t"
						"vmovups 8(%1), %%ymm6\n\t"
						...
						"vmovaps 32(%10), %%ymm8\n\t"
						"vmovups 4(%1), %%ymm10\n\t"
						"vaddps -4(%1), %%ymm10, %%ymm9\n\t"
						"vmovups 36(%1), %%ymm11\n\t"
						"vaddps 28(%1), %%ymm11, %%ymm10\n\t"
						"vmovups 68(%1), %%ymm12\n\t"
						"vaddps 60(%1), %%ymm12, %%ymm11\n\t"
						"vmovups 100(%1), %%ymm12\n\t"
						"vaddps 92(%1), %%ymm12, %%ymm13\n\t"
						"vaddps (%1,%7), %%ymm9, %%ymm9\n\t"
						"vaddps 32(%1,%7), %%ymm10, %%ymm10\n\t"
						"vaddps 64(%1,%7), %%ymm11, %%ymm11\n\t"
						"vaddps 96(%1,%7), %%ymm13, %%ymm13\n\t"
						"vaddps (%1,%9), %%ymm9, %%ymm9\n\t"
						"vaddps 32(%1,%9), %%ymm10, %%ymm10\n\t"
						"vaddps 64(%1,%9), %%ymm11, %%ymm11\n\t"
						"vaddps 96(%1,%9), %%ymm13, %%ymm13\n\t"
						"vaddps (%1,%8), %%ymm9, %%ymm9\n\t"
						"vaddps 32(%1,%8), %%ymm10, %%ymm10\n\t"
						"vaddps 64(%1,%8), %%ymm11, %%ymm11\n\t"
						"vaddps 96(%1,%8), %%ymm13, %%ymm13\n\t"
						"vaddps (%1,%6), %%ymm9, %%ymm9\n\t"
						"vaddps 32(%1,%6), %%ymm10, %%ymm10\n\t"
						"vaddps 64(%1,%6), %%ymm11, %%ymm11\n\t"
						"vaddps 96(%1,%6), %%ymm13, %%ymm13\n\t"
						"vfmaddps %%ymm5, %%ymm8, %%ymm9, %%ymm5\n\t"
						"vfmaddps %%ymm6, %%ymm8, %%ymm10, %%ymm6\n\t"
						"vfmaddps %%ymm7, %%ymm8, %%ymm11, %%ymm7\n\t"
						"vfmaddps %%ymm4, %%ymm8, %%ymm13, %%ymm4\n\t"
						...
						: "0"((int64_t)( & ( * ((__m256 * )( & u_0_m1[_idx0]))))), "1"((int64_t)( & ( * ((__m256 * )( & u_0_0[_idx0]))))), "2"((int64_t)( & ( * ((__m256 * )( & u_0_1[_idx0]))))), "r"((int64_t)((-1*(x_max*y_max))*sizeof (float))), "r"((int64_t)(x_max*sizeof (float))), "r"((int64_t)((x_max*y_max)*sizeof (float))), "r"((int64_t)((-1*x_max)*sizeof (float))), "r"((int64_t)constarr0), "r"((int64_t)min(cb_x, (x_max-4)))
						: "rax", "rbx", "rcx", "xmm0", "xmm1", "xmm10", "xmm11", "xmm12", "xmm13", "xmm2", "xmm3", "xmm4", "xmm5", "xmm6", "xmm7", "xmm8", "xmm9", "memory", "cc"
						);
					}
				}
			}
